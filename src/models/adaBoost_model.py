...
class AdaBoostModel:
    ...
    def train_model_features(self, n_estimators=1000, save=True):
        data, labels = self.data_man.get_data()
        self.clf_all_data = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1), algorithm="SAMME",
    ...
    def save_model_features(self, n_estimators=1000):
        joblib.dump(self.clf_all_data, '../models/adaBoost_all_data_model_' + str(n_estimators) + '.joblib')

    def load_model_features(self, n_estimators=1000):
        self.n_estimators_features_trained_with = n_estimators
        self.clf_all_data = joblib.load('../models/adaBoost_all_data_model_' + str(n_estimators) + '.joblib')
    ...
    def submit_test_results_features(self):
        ...
        df.to_csv(
            r'../data_sets/submissions/adaBoost_test_results_' + str(self.n_estimators_features_trained_with) + '.csv',
            index=None)
    ...
    def train_model_images(self, n_estimators=1000, save=True):
        images_train = self.data_man.get_images_data_train()
        labels = self.data_man.get_labels()
        self.clf_images_model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1), algorithm="SAMME",
                                                   n_estimators=n_estimators)
    ...
    def save_model_images(self, n_estimators=1000):
        joblib.dump(self.clf_images_model, '../models/adaBoost_images_data_model_' + str(n_estimators) + '.joblib')

    def load_model_images(self, n_estimators=1000):
        self.n_estimators_images_trained_with = n_estimators
        self.clf_images_model = joblib.load('../models/adaBoost_images_data_model_' + str(n_estimators) + '.joblib')
    ...
    def submit_test_results_images(self):
        ...
        df.insert(loc=0, column='id', value=test_ids)
        df.to_csv(
            r'../data_sets/submissions/adaBoost_test_results_images_' + str(self.n_estimators_images_trained_with) + '.csv',
            index=None)
    ...
    def train_model_images_features(self, n_estimators=1000, save=True):
        features_images_train, labels = self.concatenate_features_images_train()
        self.clf_images_features_model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1), algorithm="SAMME",
                                                n_estimators=n_estimators)
    ...
    def save_model_features_images(self, n_estimators=1000):
        joblib.dump(self.clf_images_features_model, '../models/adaBoost_features_images_data_model_' + str(n_estimators) + '.joblib')

    def load_model_features_images(self, n_estimators=1000):
        self.n_estimators_features_images_trained_with = n_estimators
        self.clf_images_features_model = joblib.load('../models/adaBoost_features_images_data_model_' + str(n_estimators) + '.joblib')
    ...
    def submit_test_results_images_features(self):
        ...
        test_ids = self.data_man.get_test_data_ids()
        df.insert(loc=0, column='id', value=test_ids)
        df.to_csv(r'../data_sets/submissions/adaBoost_test_results_images_features_' + str(self.n_estimators_features_images_trained_with) + '.csv', index=None)
    ...
    def train_model_pca_cross_validation(self, type='data_splited', n_estimators_max = 5000):
        ...
        n_estimators_min = 200
        for j in tqdm.tqdm(range(200, n_estimators_max + 100, 100)):
    ...
    def train_model_pca(self, type='all_data', num_comp=167, save=True, n_estimators=1000):
        ...
        if type == 'data_splited':
            ...
            self.clf_pca_model_splited = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1), algorithm="SAMME",
                                                n_estimators=n_estimators)
            ...
            labels = self.data_man.get_labels()
            self.clf_pca_model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1), algorithm="SAMME",
                                                n_estimators=n_estimators)
    ...
    def save_model_pca(self,num_comp=167, n_estimators=1000):
        joblib.dump(self.clf_pca_model, '../models/adaBoost_pca_model_'+str(num_comp)+'_'+str(n_estimators)+'.joblib')

    def load_model_pca(self, num_comp=167, n_estimators=1000):
        self.data_man.load_pca_data(num_components=num_comp)
        self.nbr_comp_pca_model_trained_with = num_comp
        self.n_estimators_pca_trained_with = n_estimators
        self.clf_pca_model = joblib.load('../models/adaBoost_pca_model_'+str(num_comp)+'_'+str(n_estimators)+'.joblib')
    ...
    def submit_test_results_pca(self):
        ...
        test_ids = self.data_man.get_test_data_ids()
        df.insert(loc=0, column='id', value=test_ids)
        df.to_csv(r'../data_sets/submissions/adaBoost_test_results_pca_nbcomp_'+str(self.nbr_comp_pca_model_trained_with)+'_'+str(self.n_estimators_pca_trained_with)+'.csv', index=None)
